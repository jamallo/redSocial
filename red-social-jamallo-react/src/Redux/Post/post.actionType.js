...
export const LIKE_POST_REQUEST = "LIKE_POST_POST_REQUEST";
export const LIKE_POST_SUCCESS = "LIKE_POST_POST_SUCCESS";
export const LIKE_POST_FAILURE = "LIKE_POST_POST_FAILURE";
